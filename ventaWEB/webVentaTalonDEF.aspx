        ...
        <asp:Panel ID="PanelCliente" runat="server" Visible="true">
            <div class="formulario-cliente">
                ...
                <div class="btn-whatsapp">
                    <a href="https://wa.me/543704382939?text=¡Hola! Necesito más información. ¿Podrían llamarme?" target="_blank" rel="noopener noreferrer">
        ...
        <asp:Panel ID="PanelConfirmaOperacion" runat="server" Visible="false">
            ...
            <asp:Panel ID="PanelTransferencia" CssClass="panel-transferencia" runat="server" Visible="false">
                ...
                <div align="center">
                    ...
                    <button class="btn-pago btn-copiar-cvu-alias" onclick="copyToClipboard(event, 'otxtDatosBancoParaTransferencia02', 'CVU')">Copiar CVU</button>
                </div>
                <div align="center">
                    ...
                    <button class="btn-pago btn-copiar-cvu-alias" onclick="copyToClipboard(event, 'otxtDatosBancoParaTransferencia03', 'ALIAS')">Copiar Alias</button>
                </div>
                <div>
                    <div align="center">
            ...
            <div id="myModal" class="modal">
                <div class="modal-content">
                    ...
                    <div class="modal-images">
                        <figure>
                            <img src="premios-sorteo/heladera.jpg" alt="Heladera con freezer Midea">
                            <figcaption>
                        ...
                        <figure>
                            <img src="premios-sorteo/cocina.jpeg" alt="Cocina Atlas">
                            <figcaption>
                        ...
                        <figure>
                            <img src="premios-sorteo/freidora.jpg" alt="Freidora de aire Marylan">
                            <figcaption>
