        ...
        <asp:Panel ID="PanelCliente" runat="server" Visible="true">
            <div class="formulario-cliente">
                ...
                <div class="xxxxcontenedor-inputsxxxx">
                    ...
                    <div>
                        <div id="msj-whatsapp" class="msj-whatsapp">
                        <p>Envíe un mensaje por Whatsapp solo con su Apellido y Nombre</p>
                            <a class="btn-whatsapp" href="https://wa.me/543704779106?text=Apellido y Nombre: " target="_blank" rel="noopener noreferrer">
                                <i class="bi bi-whatsapp"></i>
                            </a>
                        </div>
                        <p>Luego, haga clic en el botón</p>
        ...
        <asp:Panel ID="PanelConfirmaOperacion" runat="server" Visible="false">
                ...
                <div>
                    ...
                    <div align="center">
                      <%--  <asp:TextBox ID="TextBox2" runat="server" BackColor="LightGray" Width="90%" Text="Datos del Vendedor  Martin Ramon Quintana , Celular Número + 54 9 370 501 9399" Font-Bold="true" TextMode="MultiLine"></asp:TextBox>--%>
                        <p class="cuenta-mp">
                            Vendedor Martin Ramon Quintana - Número de Celular +54 9 370 501 9399
                        </p>
                    </div>
                    <div align="center">
            ...
            <div id="myModal" class="modal">
                <div class="modal-content">
                    ...
                    <div class="transaccion-cliente">
                    <p>¡¡¡Felicitaciones!!! 🎉🎊 ¡Usted ya está participando por los premios mayores de los sorteos! 🎁 Complete la encuesta y participice por estos premios: </p>

                    </div>
                    <div class="modal-images">
                        <figure>
                            <img src="premios-sorteo/heladera-midea-2.jpg" alt="Heladera con freezer Midea" />
                            <figcaption>
                        ...
                        <figure>
                            <img src="premios-sorteo/cocina-atlas-2.jpg" alt="Cocina Atlas" />
                            <figcaption>
                        ...
                        <figure>
                            <img src="premios-sorteo/freidora-marylan-2.jpg" alt="Freidora de aire Marylan" />
                            <figcaption>
            ...
            <asp:Panel class="panel-encuesta" ID="PanelEncuesta" runat="server" Visible="false">
                ...
                <div class="transaccion-cliente">
                    ...
                    <button id="openModalBtn" class="open-modal-btn btn" type="button">Mostrar premios</button>
                </div>
