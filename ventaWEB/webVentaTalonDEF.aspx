                                ...
                                <asp:Panel ID="PanelCliente" runat="server" Visible="true">
                                    <div class="formulario-cliente">
                                        ...
                                        <div class="contenedor-inputs">
                                            ...
                                            <asp:Label ID="olblCelularNumeroValidadoMensaje" runat="server" Text=""
                                                Font-Bold="true" ForeColor="Red" Width="45%"></asp:Label>
                                        </div>
                                        <div class="xxxxcontenedor-inputsxxxx">

                                            <asp:Label ID="olblCelularNumeroMensaje" runat="server" Text="zzz"
                                            ...
                                            <asp:Button ID="obutValidacionVerifica" runat="server" Text="Verifica"
                                        ...
                                        <%-- Botón que dirija al whatsapp --%>
                                            <div class="btn-whatsapp">
                                                <a href="https://wa.me/543704382939?text=¡Hola! Necesito más información. ¿Podrían llamarme?"
                                    ...
                                    <div class="btn-formulario contenedor-inputs">
                                        ...
                                        <asp:Label ID="olblMensajeValidacion" runat="server" Text="" ForeColor="Red">
                                        </asp:Label>
                                    </div>
                                    <%-- Formulario Cliente --%>
                                        <div class="contenedor-inputs">
                                            <asp:Label ID="Label15" runat="server" Text="Apellido y Nombres:">
                                            </asp:Label>
                                            <asp:TextBox ID="otxtClienteApyNom" runat="server" Enabled="false">
                                            </asp:TextBox>

                                        </div>
                                        <div class="contenedor-inputs">
                                            <asp:Label ID="Label3" runat="server" Text="Correo electrónico:">
                                            </asp:Label>
                                            <asp:TextBox ID="otxtCorreoElectronico" runat="server" Enabled="false">
                                            </asp:TextBox>
                                                ...
                                                <%-- <span class="text">
                                                    ...
                                                    <div id="panel-numeros">
                                                        ...
                                                        <%-- Botón Números --%>
                                                            <asp:Button ID="obutNumeros" runat="server" Text="Números"
                                                                CssClass="btn btn-numeros"
                                                                OnClientClick="scrollToSection('panel-numeros'); return false;" />
                                                        ...
                                                        <%-- Botón Premios --%>
                                                            <div id="btn-premios-container"
                                                                ...
                                                                <asp:Button ID="obutPremios" runat="server"
                                                                    ...
                                                                    Enabled="false"
                                                                    OnClientClick="scrollToSection('panel-premios'); return false;" />
                                                            </div>
